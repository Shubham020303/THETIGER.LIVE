...
const allStores = Stores.map((store, index) => {
     return (
          <div className='flex flex-col items-center' key={index}>
               <div className={'w-52 h-52 flex flex-col items-center p-3 rounded-xl mx-5 my-[10px]'} style={store.upperBGStyle}>
                    <div className={'w-4/5 text-center relative py-[2px]'} style={store.upperShapeBGStyle}>
                         ...
                         <p className={'text-sm text-' + store.upperShapeTextColor}>UPTO 80% OFF</p>
                    ...
                    <div className='w-4/5 min-h-[100px] flex items-center'>
                    ...
                    <p className='text-sm mb-2' style={store.upperTextColor}>EARN UPTO 10.5% REWARDS</p>
                    <p className='text-xs' style={store.upperTextColor}>Rewards Rates & Terms</p>
               </div>
               <div className={'w-52 h-52 flex flex-col items-center p-3 rounded-xl mx-5 my-[10px]'} style={store.lowerBGStyle}>
                    <div className={'w-4/5 text-center relative py-[2px]'} style={store.lowerShapeBGStyle}>
                         ...
                         <p className={'text-sm text-' + store.lowerShapeTextColor}>UPTO 80% OFF</p>
                    ...
                    <p className='text-sm mb-2' style={store.lowerTextColor}>EARN UPTO 10.5% REWARDS</p>
     ...
     return (
          <div className='py-10'>
               <div className='flex items-center justify-center'>
                    ...
                    <h1 className='font-ElMessiri text-2xl font-bold text-[#1A477A] mx-5'>Top Cashback Stores</h1>
                    <svg width="70" height="7" viewBox="0 0 77 7" fill="none" xmlns="http://www.w3.org/2000/svg">
