...
const ProductCard = ({ logo, productImg, bestseller, brand, brandDesc, price, rewards, finalPrice }) => {
     return (
          <div className='flex flex-col items-center bg-white rounded-2xl min-w-[210px] w-[210px] mb-1 mx-3 py-3 md:min-w-[270px] md:mx-5 md:w-[270px]'
               style={{ boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25), inset 0px 4px 4px rgba(0, 0, 0, 0.25)" }}>
               <div className='w-[100px] md:w-[140px]'>
                    <img src={logo} className='w-full h-full object-contain' />
               </div>
               <div className='py-3 w-[100px] md:w-[150px]'>
               ...
               <div className='w-full my-1 flex flex-col items-center justify-center md:my-3'>
                    <h1 className='font-medium mb-1 md:font-semibold md:mb-2'>Brand: {brand}</h1>
                    <p className='w-[85%] text-xs whitespace-normal text-justify md:text-center '>{brandDesc}</p>
               </div>
               <div>
