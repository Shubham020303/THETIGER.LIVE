     ...
     return (
          <div className='py-5 md:py-10'>
               ...
               <div className='flex items-center justify-center'>
                    <svg width="60" height="7" viewBox="0 0 77 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className='font-ElMessiri text-md font-bold text-[#1A477A] mx-5 md:text-2xl'>Amazon Top Brands</h1>
                    <svg width="60" height="7" viewBox="0 0 77 7" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div className='flex flex-col items-center justify-around mt-5 px-5 md:flex-row'>
                    <div className='w-full my-2 md:w-[32%] md:my-0'>
