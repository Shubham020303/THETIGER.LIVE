...
import realmeC30S from "../../Images/realmeC30S.png";
...
const TopSellingMobilePhone = () => {

     const slideProductsLeft = () => {
          var slider = document.getElementById('mobileSlider');
     ...
     return (
          <div className='py-10'>
               <div className='flex items-center justify-center'>
                    ...
                    <h1 className='font-ElMessiri text-2xl font-bold text-[#1A477A] mx-5'>Top Selling Mobile Phone</h1>
                    <svg width="70" height="7" viewBox="0 0 77 7" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div className='flex items-center justify-around my-5 px-5'>
                    ...
                    <div className='w-full h-full overflow-x-scroll scroll whitespace-nowrap scroll-smooth no-scrollbar flex items-center' id='mobileSlider'>
               ...
               <div className='flex items-center justify-center'>
                    <button className='bg-transparent border-[#1A477A] border-1 py-3 px-5 text-[#1A477A] transition-all hover:bg-darkBlue hover:text-white'>
                         See All Products
                    </button>
               </div>
          </div>
...
export default TopSellingMobilePhone